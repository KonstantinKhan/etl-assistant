...
| `etl-mapper`          | Mapping between domain and transport models    | [etl-mapper.md](/docs/modules/shared/etl-mapper.md)                    |
| `etl-transport-kmp`   | Transport layer models                         | [etl-transport-kmp.md](/docs/modules/shared/etl-transport-kmp.md)      |
